...
function Home(){
                    ...
                    //console.log(resultado2);
                     ...
                     if(resultado2 != null){
                        ...
                        $.each(resultado2, function(index, value2){ 
                          ...
                          porc_serv = porc_serv+((value2.vent_prof_det_porc_serv_prof*value2.vent_prof_det_cant_prod)*100);
  ...
  this.modificarDatosProductoProf = function(codigo_unico_prof_venta, codigo_prof_cabecera){
    $.getJSON('index.php', {action:'cotizaciones',tp:'getDetalleProductoEspecif', codigo_unico:codigo_unico_prof_venta}, function(res){
        ...
        $("#dialog-confirm-cot_01").attr("title", "Modificar Datos Producto");
        $("#dialog-confirm-cot_01 #contexto_dialog_cot_01").empty();
    ...
    $('#id_form_prof_venta_000545').submit(function(evt){
      ...
      if($('#venta_nueva_preventa_prod').val() == ""){
        ...
        $.getJSON('index.php?action=cotizaciones&tp=updatePrecioCantProd', {id_unico:$('#codigo_unico_preventa_prf').val(),precio_nuevo:$('#venta_nueva_preventa_prod').val(),cantidad:$('#cantidad_prof_nueva_text').val()}, function(data, textStatus, xhr) {
          ...
          $("#dialog-confirm-cot_01").dialog('close');
